...
int main() {
  ...
  PathPlanning path_planning(map_waypoints_x, map_waypoints_y, map_waypoints_s,
                             map_waypoints_dx, map_waypoints_dy);

  h.onMessage([&path_planning](uWS::WebSocket<uWS::SERVER> ws, char *data,
